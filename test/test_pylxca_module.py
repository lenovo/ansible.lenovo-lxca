...
func_dict = {
                ...
                'get_managementserver': pylxca_module._get_managementserver,
                'update_managementserver': pylxca_module._update_managementserver,
                'import_managementserver': pylxca_module._import_managementserver,
